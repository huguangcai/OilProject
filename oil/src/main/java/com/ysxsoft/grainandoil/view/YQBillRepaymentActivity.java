...
public class YQBillRepaymentActivity extends BaseActivity implements View.OnClickListener {
    private String zong;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yq_bill_repayment_layout);
...
//                        showToastMessage(e.getMessage());
                    ...
                    public void onNext(MyMsgBean response) {
                        if ("0".equals(response.getCode())){
                            ...
                            tv_balance_money.setText(zong == null ? "¥0" : "-¥" + zong);

                            ed_bill_repayment.setText("¥" + (zong == null ? "0" : zong));
                            ed_bill_repayment.setSelection(ed_bill_repayment.getText().toString().trim().length());
                            tv_current_bill.setText("当前账单共" + (zong == null ? "0" : zong) + "元");
                        }
                    }
                });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_btn:
                ...
                if (Double.valueOf(s)>Double.valueOf(zong)){
                ...
                .subscribe(new Observer<AliPayRechargeBean>() {
                    ...
                    public void onCompleted() {
                        ...
                        if ("0".equals(aliPayRechargeBean.getCode())) {
                            AlipayUtils.startAlipay(YQBillRepaymentActivity.this, handler, 0x10, aliPayRechargeBean.getData());//支付宝支付
                        }
                    }
