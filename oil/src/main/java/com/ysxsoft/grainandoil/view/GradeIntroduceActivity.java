...
import com.ysxsoft.grainandoil.adapter.GradeIntroduceAdapter;
...
public class GradeIntroduceActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    private View img_back;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private LuRecyclerViewAdapter mLuRecyclerViewAdapter = null;
    private GradeIntroduceAdapter mDataAdapter;
    ...
    private void initView() {
        ...
        mDataAdapter = new GradeIntroduceAdapter(mContext);
    ...
    private class PreviewHandler extends Handler {
        private WeakReference<GradeIntroduceActivity> ref;

        PreviewHandler(GradeIntroduceActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final GradeIntroduceActivity activity = ref.get();
